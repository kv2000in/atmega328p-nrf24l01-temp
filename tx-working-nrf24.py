...
class NRF24:
    ...
    def begin(self, major, minor, ce_pin, irq_pin):
        ...
        try:
            ...
            print " IOError - Hardware does not support this speed"
            pass  # Hardware does not support this speed

        #self.spidev.cshigh = False # Domino Pi - this keeps the CS to be high
    ...
    def ce(self, level, pulse=0):
        ...
        if self.ce_pin is not None:
            ...
            #gpio_out=GPIO(self.ce_pin, "out")
            #if level==1:
            #    gpio_out.write(True)
                #print "ce pin set to high"
            #else:
            #    gpio_out.write(False)
                #print "ce pin set to low"
        if pulse > 0:
                time.sleep(pulse)
                #print "pulse>0"
    ...
    def irqWait(self, timeout=30000):
        ...
        #gpio_in=GPIO(self.irq_pin,"in")        
        #if gpio_in.read() == False:  # Pin is already down. Packet is waiting?
            return True
